...
SELECT ALU_MATRICULA
FROM SCA.ANALYTICS_PRE_REQUISITOS
WHERE PRD_DIC_CCU_CUR_COD_CURSO = 14102100 
    AND PRD_DIC_CCU_COD_CURRICULO = 1999;

/* Alunos */
SELECT ALU_MATRICULA,
  ALU_ANO_INGRESSO || '.' || ALU_PERIODO_INGRESSO as PERIODO_INGRESSAO,
  ALU_ANO_EVASA || '.' || ALU_PERIODO_EVASAO as PERIODO_EVASAO,
  ALU_FORMA_EVASAO
FROM SCA.ANALYTICS_ALUNOS
WHERE ALU_CCU_CUR_COD_CURSO = 14102100
  AND ALU_CCU_COD_CURRICULO = 1999
order by PERIODO_INGRESSAO DESC;